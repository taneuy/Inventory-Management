...
@Component({
  selector: 'app-checkout-staff',
  templateUrl: './checkout-staff.component.html',
  styleUrls: ['./checkout-staff.component.css']
})
export class CheckoutStaffComponent implements OnInit {
